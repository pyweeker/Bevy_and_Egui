...
fn setup(
    ...
    //let brick_size = Vec2::new(64.0, 64.0);
    ...
    for row in 0..brick_rows {
        ...
        for column in 0..brick_columns {
            ...
            //let r: f32 = rnd.gen_range(0.0..1.0);
            //let g: f32 = rnd.gen_range(0.0..1.0);
            //let b: f32 = rnd.gen_range(0.0..1.0);
            //let a: f32 = rnd.gen_range(0.0..1.0);
            ...
            commands
                .spawn_bundle(SpriteBundle {
                    ...
                    sprite: Sprite {
                        ...
                        //visible: Visible {is_transparent: true,
                        //..Default::default()
                        //},
                        ...
                        //color = Color::rgba(rng.gen_range(0.0..1.0), rng.gen_range(0.0..1.0), rng.gen_range(0.0..1.0), rng.gen_range(0.0..1.0)),
                    ...
                    //texture: asset_server.load("crab_32_baseblack.png"),
                    //texture: asset_server.load("custom_RAF_64.png"),
                    texture: asset_server.load("custom_RAF_128.png"),

                    //texture: asset_server.load("python_icon_16.png"),
