...
fn setup(
    ...
    for row in 0..brick_rows {
        ...
        for column in 0..brick_columns {
            ...
            .insert(Idx_of_entity { idx: ui_state.souls.len() },);
            ...
            ui_state.souls.push(new_entity.id());
        }
    }
...
fn keyboard_system(
    ...
    if keyboard_input.just_pressed(KeyCode::Space) {
     ...
     //for foobar in ui_state.souls.iter() {println!("{:?}", foobar); print_type_of(foobar);}
     ...
     for (e, idx_of_e) in queryIDX .iter() {println!("{}", idx_of_e.idx); }
     ...
     //for foobar in ui_state.souls.iter() {println!("{:#?}", foobar); print_type_of(foobar); foobar.show_details();}

     //for foobar in ui_state.souls.iter() {for bidul in foobar.iter() {println!("{:?}", bidul);} }



     //for foobar in ui_state.souls.iter() {println!("{:?}", foobar.idx);}
     //for foobar in ui_state.souls.iter() {println!("{:?}", foobar.Idx_of_entity);}

     //for foobar in ui_state.souls.iter() {println!("{:?}", foobar.Idx_of_entity.idx);}
