...
impl Default for UiState {
    fn default() -> Self {
        ...
        UiState { value: 3.5, rotval: 0.0, vertimov: 0.0, painting: Painting::default(), inverted: true, name: "the_name".to_string(), age: 18, current_target_idx: None, current_png_String: "".to_string(), vec_entities: Vec::<Entity>::new(), vec_texturenames: Vec::<&str>::new()}
    }
}
...
fn ui_example(
    ...
    match ui_state.current_png_String.as_str() {
        "" => {let texture_handle_ONE = assets.load("python_icon.png"); egui_ctx.set_egui_texture(BEVY_TEXTURE_ID_ONE, texture_handle_ONE);},
        //"b" => println!("1"),
        //"c" => println!("2"),
